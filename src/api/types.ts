...
export const PAGE_IDS = ['dashboard', 'users', 'groups', 'apis', 'enforced', 'audit', 'accessreview', 'recertification', 'settings', 'orgadmin', 'organizations', 'apikeys', 'backup', 'accesscheck'] as const;
